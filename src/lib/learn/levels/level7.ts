...
export const LEVEL_7_LESSONS: Lesson[] = [
  {
    ...
    finalQuiz: {
      ...
      options: [
      "That the original analysis was correct",
      "Little — prices move for many other reasons",
      "That you should now buy more of the same",
      "That the company is being managed well",
    ],
      answer: 1,
      explain:
...

  {
    ...
    finalQuiz: {
      ...
      options: [
      "The research process failed and needs replacing",
      "The process may have been sound; luck was not",
      "That research does not work in practice",
      "Never invest in that industry ever again",
    ],
      answer: 1,
      explain:
...

  {
    ...
    finalQuiz: {
      ...
      options: [
      "Reading a great deal more market news daily",
      "Writing reasoning down and reviewing it later",
      "Trading more often to build up experience",
      "Following experienced investors more closely",
    ],
      answer: 1,
      explain:
