...
export const LEVEL_5_LESSONS: Lesson[] = [
  {
    ...
    finalQuiz: {
      ...
      options: [
      "It guarantees a better return over time",
      "No single mistake can then sink the portfolio",
      "Regulators require a minimum diversification",
      "Smaller positions are much easier to track",
    ],
      answer: 1,
      explain:
...

  {
    ...
    finalQuiz: {
      ...
      options: [
      "A genuinely well-diversified portfolio",
      "One bet on consumer spending, split six ways",
      "A portfolio that will track the wider market",
      "A low-risk portfolio by most definitions",
    ],
      answer: 1,
      explain:
...

  {
    ...
    finalQuiz: {
      ...
      options: [
      "That the holding is about to fall back",
      "Nothing about it — only that 30% is too much",
      "That buying it was a mistake in the first place",
      "That all holdings ought to be equally sized",
    ],
      answer: 1,
      explain:
